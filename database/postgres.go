...
// NewPool membuat connection pool untuk PostgreSQL.
func NewPool(ctx context.Context) (*pgxpool.Pool, error) {
	dsn := fmt.Sprintf(
		...
		config.GetEnv("DB_NAME", "tugas1_backend"),
	...
	cfg.MinConns = int32(config.GetEnvInt("DB_MIN_CONNS", 2))
	...
	// Ping memastikan database benar-benar bisa dihubungi.
